...
<div class="d-flex justify-content-between px-3">
    ...
    <div class="title-actions">
        <a href="{{ route('admin.admin.edit', $admin->username) }}" class="shadow-high btn btn-primary mr-2">Edit {{ $admin->name }}</a>
    ...
    <div class="card-header p-0 border-bottom-0">
        <div class="card shadow mb-3">
            ...
            <a href="#rolesAndPermissions" class="d-block card-header py-3 " data-toggle="collapse"
                ...
                <h6 class="m-0 font-weight-bold text-primary">Admin Roles And Permissions Information</h6>
            </a>
            <!-- Card Content - Collapse -->
