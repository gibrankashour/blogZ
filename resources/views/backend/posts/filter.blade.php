...
<form action="{{ route('admin.post.all') }}" method="GET" class="admin-form">
    ...
    <div class="row mb-3 justify-content-center">
        ...
        <div class="col-md-4">
            <div class="form-group row">
                <label for="users-select2" class="col-md-4 col-form-label">User</label>
                <div class="col-md-8">
                    <select name="user" id="users-select2" class="form-control" style="width: 100%">     
                        <option value="all">All</option>                          
        ...
        <div class="col-md-4">
            <div class="form-group row">
                <label for="categories-select2" class="col-md-4 col-form-label">Category</label>
                <div class="col-md-8">
                    <select name="category" id="categories-select2" class="form-control" style="width: 100%">     
                        <option value="all">All</option>     
        ...
        <div class="col-md-4">
            <div class="form-group row">
                ...
                <select name="sort_by" id="sort_by" class="form-control col-md-8">
                    <option @if(request()->input('sort_by') === 'title' OR empty(request()->input('sort_by'))) selected @endif value="title">Title</option>
                    <option @if(request()->input('sort_by') === 'user') selected @endif value="user">User name</option>
                    <option @if(request()->input('sort_by') === 'category') selected @endif value="category">Category name</option>
                    <option @if(request()->input('sort_by') === 'posts_count') selected @endif value="comments_count">Comments count</option>
                    <option @if(request()->input('sort_by') === 'status') selected @endif value="status">Status</option>   
                    <option @if(request()->input('sort_by') === 'created_at') selected @endif value="created_at">Created at</option>
                </select>
            </div>
        </div>
        <div class="col-md-4 ">
