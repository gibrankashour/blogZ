...
<form action="{{ route('admin.comment.all') }}" method="GET" class="admin-form">
        ...
        <div class="col-md-4">
            <div class="form-group row">
                ...
                <select name="sort_by" id="sort_by" class="form-control col-md-8">
                    <option @if(request()->input('sort_by') === 'author') selected @endif value="author">Author</option>
                    <option @if(request()->input('sort_by') === 'comment') selected @endif value="comment">Comment</option>   
                    <option @if(request()->input('sort_by') === 'post_title') selected @endif value="post_title">Post title</option>   
